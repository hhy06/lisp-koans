...
(define-test optional-parameters
  (assert-equal '(5 6 7) (function-with-optional-parameters 5 6 7))
  (assert-equal '(7 8 NIL) (function-with-optional-parameters 7 8))
  (assert-equal '(9 3 NIL) (function-with-optional-parameters 9))
...
(define-test rest-parameter
  ...
  (assert-equal (list 1)  (function-with-rest-parameter 1))
  (assert-equal (list 1 :two 333) (function-with-rest-parameter 1 :two 333)))
...
(define-test keyword-parameters ()
  ...
  (assert-equal (list 11 22 33) (function-with-keyword-parameters :a 11 :b 22 :c 33))
  ;; It is not necessary to specify all keyword parameters.
  (assert-equal (list :something 22 NIL) (function-with-keyword-parameters :b 22))
  ;; Keyword argument order is not important.
  (assert-equal (list 0 22 -5/2) (function-with-keyword-parameters :b 22 :c -5/2 :a 0))
  ;; Lisp handles duplicate keyword parameters.
  (assert-equal (list :something 22 NIL) (function-with-keyword-parameters :b 22 :b 40 :b 812)))
...
(define-test keyword-indication
  (assert-equal (list 2 NIL 3 NIL) (function-with-keyword-indication))
  (assert-equal (list 3 T 4 T) (function-with-keyword-indication :a 3 :b 4))
  (assert-equal (list 11 T 22 T) (function-with-keyword-indication :a 11 :b 22))
  (assert-equal (list 2 NIL 22 T) (function-with-keyword-indication :b 22))
  (assert-equal (list 0 T 22 T) (function-with-keyword-indication :b 22 :a 0)))
...
(define-test funky-parameters
  (assert-equal (list 1 NIL 1 NIL NIL) (function-with-funky-parameters 1))
  (assert-equal (list 1 2 1 NIL (list :b 2 )) (function-with-funky-parameters 1 :b 2))
  (assert-equal (list 1 2 3 T (list :b 2 :c 3)) (function-with-funky-parameters 1 :b 2 :c 3))
  (assert-equal (list 1 2 3 T '(:c 3 :b 2)) (function-with-funky-parameters 1 :c 3 :b 2)))
...
(define-test apply
  ...
  (assert-equal 6 (apply #'+ 1 2 '(3))) ; (apply #'- 1 2 '( 3 4 )) is -8
